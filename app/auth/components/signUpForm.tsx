...
export default function SignUpForm() {
  ...
  return (
    <div className="w-[400px] sm:w-[514px] h-[800px] sm:h-[822px] bg-white rounded-[20px] shadow-[0_10px_50px_0_rgba(0,0,0,0.1)] p-4 flex flex-col items-center mt-10 sm:mt-0">
