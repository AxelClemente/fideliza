  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        ...
        "
      >
        <DialogHeader className="p-3 md:p-4 pb-0 md:flex-shrink-0">
        ...
        {/* Botones fijos en desktop */}
        <div className="p-3 md:p-4 px-8 md:px-14 space-y-2 md:space-y-3 md:flex-shrink-0">
          <Button 
