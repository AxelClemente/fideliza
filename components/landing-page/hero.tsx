    ...
    return (
      <div className="relative min-h-screen bg-white flex flex-col items-start justify-start sm:justify-center mt-[100px] sm:mt-[199px]">
        ...
        <div className="relative z-10 w-full px-4 sm:px-0">
          ...
          {/* Role selection card */}
          <div className="mt-16 bg-black max-sm:mx-[-16px] max-sm:rounded-[10.72px] sm:rounded-3xl sm:mx-0 p-4 sm:p-8 pt-8 sm:pt-12 text-center min-h-[250px] sm:min-h-[412px] flex items-center justify-center">
            <div className="px-4">
